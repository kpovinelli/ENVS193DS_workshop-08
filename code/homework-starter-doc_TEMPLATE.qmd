...
**Shoot mass is strongly positvely correlated with total mass (Pearson's r = 0.902).**  

**Root mass is strongly positvely correlated with total mass (Pearson's r = 0.58).**
...
**Total biomass seems to be larger in well watered plants than drought stressed plants.**
...
**Plants with a larger specific leaf area seems to have a larger total mass. There is a moderate positive correlation between specific leaf area and total mass.**
...
Out of the four models we have tried, the best model is the one that includes **Model 4 is the best model. This is because the AICc value is the lowest (-156.2) and the delta value is 0. specific leaf area, water treatment, and species (saturated model)**  
...
**reference for water_treatment:** **drought treatment, doesn't show in model**  
...
- well watered estimate: **on average across species and SLA, well watered plants tend to be 0.12 +- 0.02 g heavier (or more massive) than drought stressed plants**    
