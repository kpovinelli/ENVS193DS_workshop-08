...
Out of the four models we have tried, the best model is the one that includes **Model 1 is the best model. This is because the AICc value is the lowest and the delta value is 0. specific leaf area, water treatment, and species (saturated model)**  
